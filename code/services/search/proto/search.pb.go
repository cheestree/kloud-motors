...
func (x *ListingSummary) GetPrice() int64 {
	if x != nil {
		return x.Price
	}
	return 0
...
const file_search_proto_rawDesc = "" +
	"\n" +
	"\fsearch.proto\x12\x06search\x1a\x1egoogle/protobuf/wrappers.proto\"\x8b\x03\n" +
	...
	"\x06is_new\x18\v \x01(\bR\x05isNew2H\n" +
	"\rSearchService\x127\n" +
...
var file_search_proto_depIdxs = []int32{
	3, // 0: search.SearchRequest.is_new:type_name -> google.protobuf.BoolValue
	2, // 1: search.SearchResponse.listings:type_name -> search.ListingSummary
