...
const file_auction_proto_rawDesc = "" +
	"\n" +
	"\rauction.proto\x12\aauction\"\x97\x03\n" +
	"\aAuction\x12\x1d\n" +
	"\n" +
...
var file_auction_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
...
func file_auction_proto_init() {
	...
	file_auction_proto_msgTypes[0].OneofWrappers = []any{}
	file_auction_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
