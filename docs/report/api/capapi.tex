...
The Kloud Motors API follows a RESTful architecture. The endpoints have been categorized by their primary domain, such as User, Chat, Auctions, and Listings. Each table provides the HTTP method, the endpoint path, and a brief description of its functionality. The full OpenAPI specification file is provided as a separate attachment in \texttt{.yaml} format.
