...
\include{introduction/capintroduction}

\include{api/capapi}
\include{requirements/caprequirements}
\include{architecture/caparchitecture}
\include{implementation/capimplementation}
\include{deployment/capdeployment}
\include{pipeline/cappipeline}
\include{tests/captests}
\include{improvements/capimprovements}
\include{costs/capcosts}

\include{conclusion/capconclusion}
