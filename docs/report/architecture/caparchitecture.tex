...
Kloud Motors follows a \textbf{microservices architecture} implemented in Go. The public surface of the application is a \textbf{REST and WebSocket gateway}, while the internal services communicate through gRPC. The same service decomposition is used for local execution with Docker Compose and for cloud execution on Kubernetes.
